...
class BulkScanRouteArgs {
  ...
  @override
  String toString() {
    return 'BulkScanRouteArgs{qrScanBloc: $qrScanBloc, firstTimeScan: $firstTimeScan, willScanDus: $willScanDus, qrCode: $qrCode, key: $key}';
  }
}
