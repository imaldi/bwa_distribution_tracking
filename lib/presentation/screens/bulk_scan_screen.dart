      ...
      child: Scaffold(
        body: BlocConsumer<QRScanBloc, QRScanState>(
          ...
          builder: (context, state) {
                                          ...
                                          children: [
                                            Builder(builder: (context) {
                                              var state = context
                                                  .watch<BulkScanScreenCubit>()
                                                  .state;
                                              var lat = double.parse(state
                                                      .sendScanDataModel
                                                      .latitude ??
                                                  "0.0");
                                              var lng = double.parse(state
                                                      .sendScanDataModel
                                                      .longtitude ??
                                                  "0.0");
                                              ...
                                              return Column(
                                                children: [
                                                  ...
                                                  Padding(
                                                    ...
                                                    child: CustomText(
                                                      "${state.sendScanDataModel.alamat ?? "Loading..."}",
                                                      color: primaryColor,
                                                    ),
                                                  ),
                                                ],
                                            ...
                                            Padding(
                                              ...
                                              child: MyDropdownButton<String>(
                                                ...
                                                value: state.loginResponse.user
                                                            ?.role ==
                                                        "Petugas"
                                                    ? "Terkirim"
                                                    : "Diterima",
            ...
            return Center(
              child: Text("State is ${state.runtimeType}"),
            );
          },
        ),
