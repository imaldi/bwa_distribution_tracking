...
class RiwayatScreenAppbarAndSearchbar extends StatelessWidget {
  const RiwayatScreenAppbarAndSearchbar({Key? key}) : super(key: key);
            ...
            child: Row(
              children: [
                Expanded(child: Container(
                    ...
                    child: const MyTextField(contentPadding: EdgeInsets.all(sizeNormal),borderRadius: sizeMedium,))),
                RoundedContainer(sizeMedium,
                    boxDecoration: const BoxDecoration(color: primaryColor),
                    child: Row(
                      children: const [
                        CustomText("Filter", color: Colors.white,),
